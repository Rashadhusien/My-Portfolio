...
const projects = [
  {
    ...
    description:
      "A full-featured e-commerce platform built with Next.js, Stripe, and Tailwind CSS. Features include product catalog, shopping cart, and secure checkout.",
  ...
  },
  {
    ...
    description:
      "A mobile fitness tracking application with workout logging, progress tracking, and social features for motivation.",
...
const categories = ["All", "Web Development", "Mobile App", "Dashboard"];
